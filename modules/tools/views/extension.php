...
<div class="row margin-bottom-40">
	...
	<div class="col-md-3">
		<div class="pricing hover-effect">
			...
			<div class="pricing-footer">
				...
				<?php echo '<a target="_blank" href="https://spruton.com/' . ($app_user['language']=='russian.php' ? 'ru/':''). 'shopping_cart.php" class="btn btn-success">' . TEXT_BUY_EXTENSION . '</a>'?>				
			</div>
		</div>
	</div>
	...
	<div class="portlet">
						...
						<div class="portlet-body" style="display: block;">
							...
							<center><a href="https://spruton.com/<?php echo ($app_user['language']=='russian.php' ? 'ru/':'')?>extension" target="_blank" class="btn btn-primary"><?php echo TEXT_MORE_INFO ?></a></center>
						</div>
					</div>
