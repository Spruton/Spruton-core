<?php
  ...
  function build_main_menu()
  {
    ...
    if($app_user['group_id']==0)
    {
      ...
      $s = array();
      $s[] = array('title'=>TEXT_MENU_REPORT_FORUM,'url'=>'https://help.spruton.com/' . $store_language,'target'=>'_blank');      
      $s[] = array('title'=>TEXT_MENU_REVIEWS,'url'=>'https://spruton.com/' . $store_language . 'reviews.php','target'=>'_blank');
      $s[] = array('title'=>TEXT_MENU_DONATE,'url'=>'https://spruton.com/' . $store_language . 'donate.php','target'=>'_blank');
      $s[] = array('title'=>TEXT_MENU_CONTACT_US,'url'=>'https://spruton.com/' . $store_language . 'contact_us.php','target'=>'_blank');
      $menu[] = array('title'=>TEXT_MENU_SUPPORT,'url'=>'https://help.spruton.com/' . $store_language,'submenu'=>$s,'class'=>'fa-envelope-o');
