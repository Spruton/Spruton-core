...
define('TEXT_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href="https://help.spruton.com/info/how-to-use-formulas-and-functions/" target="_blank"><u>See more examples.</u></a>');
...
define('TEXT_NEW_PROJECT_VERSION_INFO','Spruton %s is available! Please update now.');
...
define('TEXT_VERSION_INFO','You are using Spruton');
...
define('TEXT_CRON_BACKUP','<a href="https://help.spruton.com/info/how-to-run-a-cron-job/" target="_blank"><u>Cron</u></a> backup');
...
define('TEXT_MAX_UPLOAD_FILE_SIZE_TIP','<a href="https://help.spruton.com/info/how-to-increase-maximum-upload-file-size/" target="_blank">' . 'How to change this value?' . '</a>');
...
define('TEXT_NOTIFICATIONS_SCHEDULE_TIP','Befor enable this feature you have to configure CRON_HTTP_SERVER_HOST in config/server.php and run the file every hour (<a href="https://help.spruton.com/info/how-to-run-a-cron-job/" target="_blank"><u>Cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_INFO','Before you enable this feature, you must install the scheduled task every minute (<a href="https://help.spruton.com/info/how-to-run-a-cron-job/" target="_blank"><u>Cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_DESCRIPTION','Before you enable this feature, check <a href="https://help.spruton.com/info/how-to-configure-sending-mail/" target="_blank"><u>restrictions on sending mail</u></a> on your server.');
...
define('TEXT_FORMS_FIELDS_DISPLAY_RULES_INFO','For fields of type Drop Down you have the ability to customize the display of fields, depending on the selected list values. <a href="https://help.spruton.com/info/display-fields-rules/" target="_blank">Read more</a>');
...
define('TEXT_DASHBOARD_DEFAULT_ADMIN_MSG','<h3 class="page-title">Welcome to the Spruton – your new assistant in business management!</h3>
...
<p>Also we recommend you to visit the "<a href="https://help.spruton.com/" target="_blank">Documentation</a>". There you will find various tips on setting up the system.</p>
<p>Still have questions? You can always contact us!</p>
<p><a href="https://spruton.com" target="_blank">www.spruton.com</a></p>');
...
define('TEXT_ENTITY_ACCESS_INFO_EXTRA','<br>"Views All. Actions with Assigned" allows you to perform an action only with the assigned records.<br>"Update Selected" will be available when the Extension is installed. <a href="https://help.spruton.com/info/multiple-update/" target="_blank">More Details</a>.');
define('TEXT_CONDITION_NOT_EMPTY_VALUE','Not empty value');
define('TEXT_FIELDTYPE_AUTOSTATUS_TITLE','Automatic status');
define('TEXT_FIELDTYPE_AUTOSTATUS_TOOLTIP','After creating the field, create the necessary statuses by clicking on the field name in the field list. The status will be set automatically when creating or editing an entry, depending on the filters configured. <a href="https://help.spruton.com/info/automatic-status/" target="_blank">Read more</a>.');
...
define('TEXT_USERS_ALERTS_INFO','On this page you have the ability to create alerts for selected users or groups of users. <a href="https://help.spruton.com/info/users-alerts/" target="_blank">Read more</a>.');
...
define('TEXT_CHOICES_VALUE_INFO','The value can be used in formula calculations. <a href="https://help.spruton.com/info/formula-calculations/" target="_blank">Read more</a>');
...
define('TEXT_JS_FORMULA_TIP','Use [Field ID] to setup field value in formula. Example: ([36]+[54])/2. Where 36 and 54 are ID of numeric fields. <a href="https://help.spruton.com/info/formula-calculations/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ACCESS_ALLOCATION_RULES_INFO','On this page you have the ability to configure user access depending on the values of the selected field. <a href="https://help.spruton.com/info/access-rules/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_REPORTS_GROUPS_INFO','Group reports by a specific entity or data and display them on a separate page. <a href="https://help.spruton.com/info/reports/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_MYSQL_QUERY_TOOLTIP','A special type of field for creating a custom MySQL query to the selected entity. <a href="https://help.spruton.com/info/mysql-query/" target="_blank"><u>Read more.</u></a>.');
...
define('TEXT_FIELDTYPE_MIND_MAP_TOOLTIP','Special field type to build mind map. A mind map is a diagram used to visually organize information. A mind map is hierarchical and shows relationships among pieces of the whole. <a href="https://help.spruton.com/info/mind-map-tool/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_LISGIN_CONFIGURATION_INFO','On this page, you can customize the appearance of the list of records. <a href="https://help.spruton.com/info/configure-view/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_LDAP_INFO','This feature enables LDAP authentication and creates users in a database that successfully authenticate. <a href="https://help.spruton.com/info/ldap-support/" target="_blank"><u>Read more.</u></a>');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TITLE','Days difference');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in days between two dates. <a href="https://help.spruton.com/info/working-with-dates/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_HOURS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in hours between two dates. <a href="https://help.spruton.com/info/working-with-dates/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_HOLIDAYS_INFO','Holiday dates can be excluded when calculating the difference of days. <a href="https://help.spruton.com/info/working-with-dates/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_YEARS_DIFFERENCE_TOOLTIP','A special type of field that calculates the difference in years between two dates. <a href="https://help.spruton.com/info/working-with-dates/" target="_blank"><u>Read more.</u></a>');
define('TEXT_CALCULATE_DIFFERENCE_DAYS','Calculate the difference in days');
define('TEXT_FIELDTYPE_PHONE','Phone');
define('TEXT_FIELDTYPE_PHONE_TOOLTIP','A special field type to enter phone number. Can be configured to make calls. <a href="https://help.spruton.com/info/telephony/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_DASHBOARD_CONFIGURATION_INFO','You can add info blocks or pages on home page. In info block you can output information about current user. <a href="https://help.spruton.com/info/dashboard/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_HELP_SYSTEM_INFO','Create informational pages and announcements for a specific entity. <a href="https://help.spruton.com/info/help-system/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ENTITIES_PAGE_INFO','Spruton allows you build your own database by adding new entities and relationships. <a href="https://help.spruton.com/info/extend-your-application/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_TOOLTIP','Field to display the marker on the map. The coordinates of the marker are determined automatically by the entered address. <a href="https://help.spruton.com/info/maps-integration/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_TAGS_TOOLTIP','A special field type that allows you to select an existing option or dynamically create a new option in the drop-down list. <a href="https://help.spruton.com/info/tags/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_USER_ROLES_TOOLTIP','This field type allows you to assign a user to a record and set an additional access role for nested entities. After creating the field, click the field name and add the required user roles. <a href="https://help.spruton.com/info/user-roles/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_ALL_USERS_APPROVED_INFO','Select the action that will be run once all users has be approved record. The action can be configured in <a href="https://help.spruton.com/info/processes/" target="_blank">Extension->Automatic Actions</a>.');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_TOOLTIP','Field to display multiple markers on the map. The coordinates of the markers are determined automatically by the entered addresses. The specified markers can be used to create a route. <a href="https://help.spruton.com/info/maps-integration/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FORM_CONFIG_INFO','On this page, you have the ability to sort the fields in the form, create additional tabs for the fields, and embed your JavaScript code into the form. <a href="https://help.spruton.com/info/form-configuration/" target="_blank">Read More</a>.');
...
define('TEXT_DEFAULT_NOTIFICATIONS_INFO','By default, notifications are sent to all assigned users. Use the Users field type to assign users to a record.<br>For more flexible notification settings, use the <a href="https://help.spruton.com/info/email-sending-rules/" target="_blank">Mail sending rules</a>.');
...
define('TEXT_RECORDS_VISIBILITY_INFO','Configure the visibility of records depending on the value of the fields. <a href="https://help.spruton.com/info/records-visibility/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_FIELDTYPE_STAGES_TOOLTIP','A special type of field that displays the stages panel on the record page, with which you can quickly move to the next stage. After creating the field, click on the name to create the stages. <a href="https://help.spruton.com/info/stages/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_2STEP_VERIFICATION_INFO','If enabled, the user, when entering the system, in addition to the credentials, will need to enter a special code sent to the user by email or SMS. <a href="https://help.spruton.com/info/2-step-verification/" target="_blank"><u>Read more.</u></a>');
...
define('TEXT_CODE_FROM_EMAIL_INFO','You have been sent a message with a code to the address %s');
