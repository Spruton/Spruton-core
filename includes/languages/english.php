...
define('TEXT_ENTER_TEXT_PATTERN_INFO','Use [ID field] to set the value of the field in the template.<br>Example: "[36] your text [54]" where the 36 and 54 - fields ID.<br>Also available: [id], [date_added], [created_by], [parent_item_id], [current_user_name]');
...
<p>Also we recommend you to visit the "Documentation" page on our <a href="https://help.spruton.com/" target="_blank">blog</a>. There you will find various tips on setting up the system.</p>
...
define('TEXT_EXTENSION_FEATURES_LIST','<h4>Main Features</h4>,Public Forms,Business process automation,Rest API,Formulas and Functions,Сalendar,Templates,<h4>Tools</h4>,Recurring Tasks,Currencies,Multiple update,Online chat,Info Pages,Time Tracking and Timer Reports,<h4>Reports</h4>,Funnel Chart,Change History Report,Pivot Table Reports,Common Reports,Timeline Report,Gantt Chart,Charts and Graphs,Kanban Board,Image Map,Mind Map,Map,<h4>Modules</h4>,Payment Modules,SMS Modules,File Storage Modules,Smart Input');
...
define('TEXT_NUMERICAL_SORTING', 'Numerical sorting');
...
define('TEXT_FIELDTYPE_TAGS_TOOLTIP','A special field type that allows you to select an existing option or dynamically create a new option in the drop-down list.');
...
// vk chat
define('TEXT_DEL_CHAT','Delete chat');
define('TEXT_PROFILE_CHAT','Profile');
