...
<p>Если вы еще не успели ознакомиться с системой более подробно, рекомендуем посетить раздел "Документация" на нашем блоге <a href="https://help.spruton.com/ru/" target="_blank">help.spruton.com</a>. Там вы найдете различные советы по настройке системы.</p>
...
define('TEXT_EXTENSION_FEATURES_LIST','<h4>Основные возможности</h4>,Публичные формы,Автоматизация бизнес-процессов,Rest API,Формулы и Функции,Календарь,Шаблоны,<h4>Инструменты</h4>,Повторяющиеся задачи,Валюты,Множественное обновление,Онлайн чат,Информационные страницы,Учет времени и временные отчеты,<h4>Отчеты</h4>,Воронкообразная диаграмма,История изменений,Сводные отчеты,Общие отчеты,Отчеты по шкале времени,Диаграмма Ганта,Графики и диаграммы,Канбан-доска,Mind map,План-схема,Карта,<h4>Модули</h4>,Модули оплаты,СМС модули,Модули хранения файлов,Умный ввод');
...
define('TEXT_NUMERICAL_SORTING', 'Числовая сортировка');
...
define('TEXT_FIELDTYPE_YEARS_DIFFERENCE_TOOLTIP','Специальный тип поля, который высчитывает разницу в годах между двумя датами. <a href="https://help.spruton.com/ru/working-with-dates" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_DASHBOARD_CONFIGURATION_INFO','На главную страницу можно добавить информационные блоки или страницы. В инфо блоке можно выводить информацию о текущем пользователе. <a href="https://help.spruton.com/ru/dashboard" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_HELP_SYSTEM_INFO','Создавайте информационные страницы и объявления для конкретной сущности. <a href="https://help.spruton.com/ru/help-system" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ENTITIES_PAGE_INFO','Спрутон позволяет создавать собственную базу данных путем добавления новых сущностей и связей. <a href="https://help.spruton.com/ru/extend-your-application" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_TOOLTIP','Поле для отображения маркера на карте. Координаты маркера определяются автоматически по введенному адресу. <a href="https://help.spruton.com/ru/maps-integration" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_DEFAULT_FILTER_PANEL_INFO','Вы можете отключить данную панель или показывать ее для определенных групп пользователей.  <a href="https://help.spruton.com/ru/filters-panels" target="_blank"><u>Подробнее.</u></a>');
define('TEXT_QUICK_FILTERS_PANELS','Панели быстрых фильтров');
define('TEXT_QUICK_FILTER_PANEL_INFO','Данные панели применяются для фильтрации данных по наиболее часто используемым параметрам. Вы можете создать горизонтальную или вертикальную панель быстрых фильтров. В настройках панели можно выбрать поля и значения, которые будут использоваться для фильтров. <a href="https://help.spruton.com/ru/filters-panels" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_TAGS_TOOLTIP','Специальный тип поля, который позволяет выбрать уже существующую или динамически создать новую опцию в раскрывающемся списке.');
...
define('TEXT_FIELDTYPE_USER_ROLES_TOOLTIP','Данный тип поля позволяет назначить пользователя на запись и установить ему дополнительную роль доступа для вложенных сущностей. После создания поля, нажмите на название поля и добавьте необходимые роли пользователей. <a href="https://help.spruton.com/ru/user-roles" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ALL_USERS_APPROVED_INFO','Выберите действие, которое будет выполняться после утверждения записи всеми пользователями. Действие можно настроить в <a href="https://help.spruton.com/ru/processes" target="_blank">Дополнение->Автоматизация действий</a>.');
...
// vk chat
define('TEXT_DEL_CHAT','Удалить чат');
define('TEXT_PROFILE_CHAT','Профиль');
