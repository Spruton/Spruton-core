...
define('TEXT_FIELDTYPE_USER_USERNAME_TITLE','Логин');
...
define('TEXT_ERROR_USERNAME_EXIST','Логин уже существует!');
define('TEXT_ERROR_USEREMAL_EMPTY','E-mail пользователя не может быть пустым');
define('TEXT_ERROR_USERNAME_EMPTY','Логин не может быть пустым');
...
define('TEXT_LDAP_ERROR_BINDING','Ошибка соединения с сервером при использовании указанных логина и пароля.');
define('TEXT_LDAP_ERROR_INCORRECT_PASSWORD','Вы указали неверный пароль. Пожалуйста, проверьте пароль и попробуйте еще раз.');
define('TEXT_LDAP_ERROR_INCORRECT_USERNAME','Вы указали неверное логин. Пожалуйста, проверьте свои имя и повторите попытку.');
...
define('TEXT_FORMULA_TIP','Используйте [ID поля] для установки значения поля в формуле. Пример: ([36]+[54])/2 где 36 и 54 - идентификаторы числовых полей. <a href="https://help.spruton.com/ru/info/how-to-use-formulas-and-functions/" target="_blank"><u>Посмотреть больше примеров</u></a>');
...
define('TEXT_NEW_PROJECT_VERSION_INFO','Новая версия Спрутон %s доступна для скачивания');
...
define('TEXT_VERSION_INFO','Вы используете Спрутон');
...
define('TEXT_POWERED_BY','Работает на платформе');
...
define('TEXT_ALLOW_CHANGE_USERNAME','Разрешить изменять логин');
...
define('TEXT_USERS_IMPORT_NOTE','При импорте пользователей, обязательными являются следующие поля: Имя, Фамилия, E-mail. Если логин не указан, то используется логин из E-mail<br>
...
define('TEXT_IMPORT_SET_PWD_AS_USERNAME','Использовать логин в качестве пароля');
...
define('TEXT_CRON_BACKUP','Резервное копирование с помощью <a href="https://help.spruton.com/ru/info/how-to-run-a-cron-job/" target="_blank"><u>cron</u></a>');
...
define('TEXT_MAX_UPLOAD_FILE_SIZE_TIP','<a href="https://help.spruton.com/ru/info/how-to-increase-maximum-upload-file-size/" target="_blank">' . 'Как изменить это значение?' . '</a>');
...
define('TEXT_NOTIFICATIONS_SCHEDULE_TIP','Перед включением данной возможности необходимо настроить CRON_HTTP_SERVER_HOST в файле config/server.php и создать задачу, которая будет выполняться каждый час (<a href="https://help.spruton.com/ru/info/how-to-run-a-cron-job/" target="_blank"><u>cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_INFO','Перед включением данной возможности необходимо установить задачу по расписанию каждую минуту (<a href="https://help.spruton.com/ru/info/how-to-run-a-cron-job/" target="_blank"><u>cron</u></a>):');
...
define('TEXT_SEND_EMAILS_ON_SCHEDULE_DESCRIPTION','Перед включением данной возможности проверьте <a href="https://help.spruton.com/ru/info/how-to-configure-sending-mail/" target="_blank"><u>ограничения на отправку почты</u></a> на вашем сервере.');
...
define('TEXT_FORMS_FIELDS_DISPLAY_RULES_INFO','Для полей типа список у вас есть возможность настроить отображение полей, в зависимости от выбранного значения списка. <a href="https://help.spruton.com/ru/info/display-fields-rules/" target="_blank">Подробнее</a>');
...
define('TEXT_DASHBOARD_DEFAULT_ADMIN_MSG','<h3 class="page-title">Вас приветствует Спрутон – ваш новый помощник в ведении дел!</h3> 
...
<p>Если вы еще не успели ознакомиться с системой более подробно, рекомендуем посетить раздел "<a href="https://help.spruton.com/ru/" target="_blank">Документация</a>". Там вы найдете различные советы по настройке системы.</p>
<p>Остались вопросы? Вы всегда можете обратиться к нам за помощью! </p>
<p><a href="https://spruton.com/ru/" target="_blank">www.spruton.com</a></p>');
...
define('TEXT_ENTITY_ACCESS_INFO_EXTRA','<br>Опция "Просмотр всех. Действия с назначенными" разрешает выполнять действия только с назначенными записями.<br>Опция "Обновить выбранные" будет доступна при установленном дополнении. <a href="https://help.spruton.com/ru/info/multiple-update/" target="_blank">Подробнее.</a>');
define('TEXT_CONDITION_NOT_EMPTY_VALUE','Непустое значение');
define('TEXT_FIELDTYPE_AUTOSTATUS_TITLE','Автоматический статус');
define('TEXT_FIELDTYPE_AUTOSTATUS_TOOLTIP','После создания поля, создайте необходимые статусы, нажав на имя поля в списке полей. Статус будет устанавливаться автоматически при создании или редактировании записи, в зависимости от настроенных фильтров. <a href="https://help.spruton.com/ru/info/automatic-status/" target="_blank">Подробнее</a>.');
...
define('TEXT_USERS_ALERTS_INFO','На этой странице у вас есть возможность создавать оповещения для выбранных пользователей  или групп пользователей. <a href="https://help.spruton.com/ru/info/users-alerts/" target="_blank">Подробнее</a>.');
...
define('TEXT_CHOICES_VALUE_INFO','Значение может использоваться в вычислениях формулы. <a href="https://help.spruton.com/ru/info/formula-calculations/" target="_blank">Подробнее</a>');
...
define('TEXT_JS_FORMULA_TIP','Используйте [ID поля] для установки значения поля в формуле. Пример: ([36]+[54])/2 где 36 и 54 - идентификаторы числовых полей. <a href="https://help.spruton.com/ru/info/formula-calculations/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ACCESS_ALLOCATION_RULES_INFO','На этой странице у вас есть возможность настроить доступ пользователей в зависимости от значений выбранного поля. <a href="https://help.spruton.com/ru/info/access-rules/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_TODO_LIST_TOOLTIP','Специальный тип поля позволяющий вам создавать список дел (подзадач) в рамках одной задачи. Каждая подзадача вводится с новой строчки в текстовом поле. Символ * в начале строки означает, что подзадача завершена. <a href="https://help.spruton.com/ru/info/todo-list/" target="_blank"><u>Подробнее</u></a>.');
...
define('TEXT_REPORTS_GROUPS_INFO','Группируйте отчеты по определенной сущности или данным и выводите их на отдельной странице. <a href="https://help.spruton.com/ru/info/reports/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_FIELDTYPE_MYSQL_QUERY_TOOLTIP','Специальный тип поля для создания пользовательского MySQL запроса к выбранной сущности. <a href="https://help.spruton.com/ru/info/mysql-query/" target="_blank"><u>Подробнее</u></a>.');
...
define('TEXT_FIELDTYPE_IMAGE_MAP_TOOLTIP','Это специальный тип поля для отображения пользовательских карт, поэтажных планов, создания пользовательских меток маркеров на карте и многое другое. После создания поля нажмите на название и добавьте варианты карт и загрузите свое изображение для каждого варианта. <a href="https://help.spruton.com/ru/info/image-map/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_FIELDTYPE_MIND_MAP_TOOLTIP','Специальный тип поля для построения диаграммы связей в виде древовидной схемы, на которой изображены слова, идеи, задачи связанные ветвями, отходящими от центрального понятия или идеи. <a href="https://help.spruton.com/ru/info/mind-map-tool/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_LISGIN_CONFIGURATION_INFO','На этой страницы вы можете настроить варианты внешнего вида списка записей. <a href="https://help.spruton.com/ru/info/configure-view/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_LDAP_INFO','Для аутентификации в системе Спрутон пользователи смогут использовать свои LDAP данные. <a href="https://help.spruton.com/ru/info/ldap-support/" target="_blank"><u>Подробнее.</u></a>');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TITLE','Разница в днях');
define('TEXT_FIELDTYPE_DAYS_DIFFERENCE_TOOLTIP','Специальный тип поля, который высчитывает разницу в днях между двумя датами. <a href="https://help.spruton.com/ru/info/working-with-dates/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_HOURS_DIFFERENCE_TOOLTIP','Специальный тип поля, который высчитывает разницу в часах между двумя датами. <a href="https://help.spruton.com/ru/info/working-with-dates/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_HOLIDAYS_INFO','Праздничные даты можно исключить при расчете разницы дней. <a href="https://help.spruton.com/ru/info/working-with-dates/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_YEARS_DIFFERENCE_TOOLTIP','Специальный тип поля, который высчитывает разницу в годах между двумя датами. <a href="https://help.spruton.com/ru/info/working-with-dates" target="_blank"><u>Подробнее.</u></a>');
define('TEXT_CALCULATE_DIFFERENCE_DAYS','Вычислять разницу в днях');
define('TEXT_FIELDTYPE_PHONE','Телефон');
define('TEXT_FIELDTYPE_PHONE_TOOLTIP','Специальный тип поля для ввода телефона. Можно настроить для совершения звонков. <a href="https://help.spruton.com/ru/telephony" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_DASHBOARD_CONFIGURATION_INFO','На главную страницу можно добавить информационные блоки или страницы. В инфо блоке можно выводить информацию о текущем пользователе. <a href="https://help.spruton.com/ru/info/dashboard" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_HELP_SYSTEM_INFO','Создавайте информационные страницы и объявления для конкретной сущности. <a href="https://help.spruton.com/ru/info/help-system" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ENTITIES_PAGE_INFO','Спрутон позволяет создавать собственную базу данных путем добавления новых сущностей и связей. <a href="https://help.spruton.com/ru/info/extend-your-application" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_TOOLTIP','Поле для отображения маркера на карте. Координаты маркера определяются автоматически по введенному адресу. <a href="https://help.spruton.com/ru/info/maps-integration" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_DEFAULT_FILTER_PANEL_INFO','Вы можете отключить данную панель или показывать ее для определенных групп пользователей.  <a href="https://help.spruton.com/ru/info/filters-panels" target="_blank"><u>Подробнее.</u></a>');
define('TEXT_QUICK_FILTERS_PANELS','Панели быстрых фильтров');
define('TEXT_QUICK_FILTER_PANEL_INFO','Данные панели применяются для фильтрации данных по наиболее часто используемым параметрам. Вы можете создать горизонтальную или вертикальную панель быстрых фильтров. В настройках панели можно выбрать поля и значения, которые будут использоваться для фильтров. <a href="https://help.spruton.com/ru/info/filters-panels" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FIELDTYPE_TAGS_TOOLTIP','Специальный тип поля, который позволяет выбрать уже существующую или динамически создать новую опцию в раскрывающемся списке. <a href="https://help.spruton.com/ru/info/tags/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_FIELDTYPE_USER_ROLES_TOOLTIP','Данный тип поля позволяет назначить пользователя на запись и установить ему дополнительную роль доступа для вложенных сущностей. После создания поля, нажмите на название поля и добавьте необходимые роли пользователей. <a href="https://help.spruton.com/ru/info/user-roles" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_ALL_USERS_APPROVED_INFO','Выберите действие, которое будет выполняться после утверждения записи всеми пользователями. Действие можно настроить в <a href="https://help.spruton.com/ru/info/processes" target="_blank">Дополнение->Автоматизация действий</a>.');
...
define('TEXT_FIELDTYPE_GOOGLE_MAP_DIRETIONS_TOOLTIP','Поле для отображения нескольких маркеров на карте. Координаты маркеров определяются автоматически по введенным адресам. По заданным маркерам можно проложить маршрут. <a href="https://help.spruton.com/ru/info/maps-integration/" target="_blank"><u>Подробнее.</u></a>');
...
define('TEXT_FORM_CONFIG_INFO','На этой странице у вас есть возможность отсортировать поля в форме, создать дополнительные вкладки для полей а также встроить свой JavaScript код в форму. <a href="https://help.spruton.com/ru/info/form-configuration/" target="_blank">Подробнее</a>.');
...
define('TEXT_RECORDS_VISIBILITY_INFO','Настройте видимость записей в зависимости от значения полей. <a href="https://help.spruton.com/ru/info/records-visibility/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_FIELDTYPE_STAGES_TOOLTIP','Специальный тип поля, который отображает панель этапов на странице записи, с помощью которой можно оперативно перейти на следующий этап. После создания поля, нажмите на название чтобы создать этапы. <a href="https://help.spruton.com/ru/info/stages/" target="_blank"><u>Подробнее</u></a>');
...
define('TEXT_2STEP_VERIFICATION_INFO','Если включено, пользователю при входе в систему помимо учетных данных необходимо будет ввести специальный код, отправленный по email или СМС. <a href="https://help.spruton.com/ru/info/2-step-verification/ " target="_blank"><u>Подробнее.</u></a>');
