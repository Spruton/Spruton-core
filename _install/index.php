...
// set default timezone if none exists (PHP 5.3 throws an E_WARNING)
  ...
  {
    $app_title = sprintf('Spruton %s Installation',PROJECT_VERSION);
  }
  
  
       
  if($_GET['step']=='spruton_config') include('actions/check_db_settings.php');
  
  if($_GET['action']=='install_spruton') include('actions/install_spruton.php');
...
<?php if($_GET['step']=='spruton_config') include('modules/spruton_config.php')?>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
	 <a href="https://spruton.com">Spruton <?php echo PROJECT_VERSION ?></a><br>
    Copyright &copy; <?php echo date('Y')?> <a href="https://spruton.com">www.spruton.com</a>
</div>
<!-- END COPYRIGHT -->
