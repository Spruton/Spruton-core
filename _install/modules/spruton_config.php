...
<form name="configuration" id="configuration" action="index.php?step=spruton_config&action=install_spruton&lng=<?php echo $_GET['lng']?>" method="post"  class="form-horizontal">
