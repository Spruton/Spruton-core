<?php
  ...
  {
    case 'ru':
        define('TEXT_APP_TITLE','Спрутон Дополнение | Автоматическое обновление базы данных  с ' . TEXT_UPDATE_VERSION_FROM .' до ' . TEXT_UPDATE_VERSION_TO);
      ...
      break;
    default:
        define('TEXT_APP_TITLE','Spruton Extension | Database Auto Update from ' . TEXT_UPDATE_VERSION_FROM . ' to' . TEXT_UPDATE_VERSION_TO);
