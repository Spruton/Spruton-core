...
('1','0','0','0','" . time() . "','0',NULL,'0','" . $hasher->HashPassword($_POST['user_password']) . "','1','0','" . db_input($_POST['fields'][7]) . "','" . db_input($_POST['fields'][8]) . "','" . db_input($_POST['fields'][9]) . "','','" . db_input($_POST['fields'][12]) . "','" . $_GET['lng'] . ".php','blue'," . time() . ");
";  
